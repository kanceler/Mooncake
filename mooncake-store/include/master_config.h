...
struct MasterConfig {
    ...
    std::array<ObjectTypeEvictionScorePolicy, UINT8_MAX + 1>
        object_type_eviction_score_policies{};
    std::array<ObjectTypeEvictionPolicy, UINT8_MAX + 1>
...
class MasterServiceConfigBuilder {
   ...
   public:
    ...
    MasterServiceConfigBuilder& set_object_type_eviction_score_policy(
        ...
        object_type_eviction_score_policies_[static_cast<uint8_t>(data_type)] =
            policy;
        return *this;
    }
    ...
    MasterServiceConfigBuilder& set_object_type_eviction_policy(
        ...
        object_type_eviction_policies_[static_cast<uint8_t>(data_type)] =
            policy;
        return *this;
    }
